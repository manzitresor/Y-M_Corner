...
- Display Meals Category From API
- You can Add Like
- display Likes
- You can Add comment
- display Comments
...
Feel free to check the <a href="https://github.com/manzitresor/js_Capstone/issues">issues page</a>
...
I would like to thank the Microverse community and for providing required API.
.
